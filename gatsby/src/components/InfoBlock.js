...
export const InfoBlock = withMenuComponentBlock({
  ...
  Component: () => <div className='info-column'>
     ...
     „We are Legion“ vereint Gemeinschaftlichkeit und Progress in einer Gilde. Erfolge wie Cutting Edge und Tequilla auf Ex können wir unser Eigen nennen.
     Unser aktuelles Ziel ist es unter den besten 1000 Gilden der Welt zu spielen.

     "Eine Gemeinschaft wird nicht durch ihre Erfolge geprägt, sondern wie sie mit Misserfolgen umgehen kann" 
    </div>
  </div>,
});
